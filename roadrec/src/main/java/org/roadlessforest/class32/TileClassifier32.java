...
public class TileClassifier32 {

    private static Logger logger = LoggerFactory.getLogger(TileClassifier32.class);
...
//        int batchSize = 128;
        ...
        File root = new File("E:/completeness_data/classify170427");
