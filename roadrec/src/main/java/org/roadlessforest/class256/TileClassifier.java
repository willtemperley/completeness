...
public class TileClassifier {
    ...
    private static Logger logger = LoggerFactory.getLogger(TileClassifier.class);
...
//        int batchSize = 128;
        int batchSize = 64;
        int outputNum = 4;  //n classes
        int epoch = 50;

        File training = new File("E:/completeness/roadrec/reclass_png/train");
        File testing = new File("E:/completeness/roadrec/reclass_png/test");
